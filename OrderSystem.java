...
public class OrderSystem extends Application {
	...
	public void start(Stage welcomeStage) throws Exception {
        ...
        try{
            File file = new File("Ordersystem.txt");
            PrintWriter writer = new PrintWriter(file);
            writer.write("Order system"    
